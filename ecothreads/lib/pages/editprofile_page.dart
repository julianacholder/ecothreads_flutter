          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: const Color(0xFFDFDEDE), width: 1), // Border
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(
                        vertical: 0, horizontal: 0), // No padding
                    backgroundColor:
                        Colors.transparent, // No background for elevated button
                    elevation: 0, // No shadow
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(20), // Uniform rounded corners
                    ),
                  ),
                  child: const Center(
                    child: Text(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  _actionButton(
                      "Donate", () => _showToast("Donate button pressed")),
                  const SizedBox(width: 8),
                  _actionButton(
                      "Redeem", () => _showToast("Redeem button pressed")),
                  const SizedBox(width: 8),
                  _actionButton(
                      "Explore", () => _showToast("Explore button pressed")),
                ],
              ),
            ),
            const SizedBox(height: 12),
            Padding(
              padding: const EdgeInsets.only(
                  top: 14.0, left: 16.0), // Adjusting position
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(
                        vertical: 16, horizontal: 84), // Custom padding
                    backgroundColor: Colors.black,
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(20), // Rounded on all sides
                    ),
                    elevation: 0, // No shadow
                  ),
                  child: const Text(
      ...
      children: [
        ...
        Text(label,
            style: const TextStyle(
                fontSize: 14)), // Label below the icon and number
      ],
    );
  }
}
